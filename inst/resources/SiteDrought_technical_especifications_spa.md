...
(a) Parcelas del cuarto Inventario Forestal Nacional (IFN4) en Cataluña.
(b) Parcelas de seguimiento de matorral del proyecto
     [MatoSeg](https://matoseg.ctfc.es), con el apoyo de la *Fundación Biodiversidad*, del *Ministerio para la Transición Ecológica y el Reto Demográfico*.
(c) Parcelas forestales permanentes del Parque Nacional de Aigüestortes y
     Estanque de San Mauricio.
(d) Parcelas del Inventario Forestal Nacional (IFN3) del Parque Nacional
...
- **Vegetación** - Las fuentes de datos de parcelas de vegetación citadas en la introducción.
...
Los autores expresan su gratitud hacia la [Agencia Estatal de Meteorología (AEMET)](http://www.aemet.es) y el [Servicio Meteorológico de Cataluña (SMC)](http://www.meteo.cat ) para proporcionar diariamente datos meteorológicos necesarios para esta aplicación; y al *Servei de Prevenció d' Incendis Forestals* de la *Generalitat de Catalunya* para los consejos en su desarrollo.

### Financiación

El proyecto **MODOSIN** (*Monitoreo y modelización integrados en un sistema de alerta de la vulnerabilidad climática en bosques de montaña*) se llevado a cabo con el apoyo del *Ministerio de Agricultura, Alimentación y Medio Ambiente (Organismo Autónomo de Parques Nacionales)*.

El proyecto **MatoSeg** (*Red de detección, predicción y seguimiento de los efectos de la sequía sobre la estructura y biodiversidad de formaciones arbustivas mediterráneas del este peninsular*) se ha llevado a cabo con el apoyo de la *Fundación Biodiversidad*, del *Ministerio para la Transición Ecológica y el Reto Demográfico* y un convenio con el *Servei de Prevenció d’Incendis Forestals* de la *Generalitat de Catalunya*.
