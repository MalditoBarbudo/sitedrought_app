...
**SiteDroughtApp** currently provides information for four sets of vegetation plots:
  ...
  (b) Shrubland monitoring plots ([MatoSeg](https://matoseg.ctfc.es) project, CTFC).
